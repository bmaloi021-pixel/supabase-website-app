...
const AdminPaymentMethodsPanel = ({ displayMode = 'page', className, onNavigateBack }: AdminPaymentMethodsPanelProps) => {
      ...
      <div className="mt-4 space-y-4">
        {filteredMethods.map((method) => {
          ...
          return (
            <div
              key={method.id}
              className="rounded-[26px] border border-[#1c3f4c]/60 bg-[#0b1e27] p-6 shadow-[0_20px_35px_rgba(0,0,0,0.35)]"
            >
              <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                <div className="flex-1 flex items-start gap-4">
                  <div className="rounded-full bg-[#132531] p-3 text-[#f3cc84]">
                  ...
                  <div>
                    ...
                    <div className="mt-2 inline-flex items-center">
                      <span
                        className={`inline-flex items-center justify-center rounded-full px-5 py-2 text-xs font-semibold uppercase tracking-[0.3em] ${
                    ...
                    <p className="text-sm text-[#9fc3c1] mt-2">
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center">
                  <div className="rounded-2xl border border-[#1c3f4c] bg-[#07161f] p-4 text-sm text-[#9fc3c1] min-w-[200px]">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    {method.qr_url ? (
                      <img src={method.qr_url} alt={`${label} payment QR`} className="h-48 w-48 rounded-xl border border-[#1c3f4c] object-cover" />
                    ) : (
                  ...
                  <div className="flex flex-col gap-2 min-w-[180px]">
                    <button
                      ...
                      className={`inline-flex items-center justify-center rounded-2xl border border-[#1c3f4c] px-5 py-2 text-sm font-semibold uppercase tracking-[0.25em] text-[#9fc3c1] hover:bg-[#132028] transition ${
                    ...
                    <button
                      ...
                      className={`inline-flex items-center justify-center rounded-2xl px-5 py-2 text-sm font-semibold uppercase tracking-[0.25em] transition ${
                        method.is_public
                    ...
                    <button
                      ...
                      disabled={workingId === method.id}
                      className="inline-flex items-center justify-center rounded-2xl border border-red-500/40 px-5 py-2 text-sm font-semibold uppercase tracking-[0.25ea] text-red-200 hover:bg-red-900/30 disabled:opacity-40"
                    >
  ...
  if (isAuthorizing) {
    ...
    return (
      <div className="rounded-[32px] border border-[#1f4e5a]/60 bg-[#061019] p-6 text-center text-[#9fc3c1]">Checking access…</div>
    );
  }
      ...
      <div className="rounded-[32px] border border-[#1f4e5a]/60 bg-gradient-to-br from-[#0c2735] via-[#0f3445] to-[#071720] p-8 shadow-[0_25px_45px_rgba(0,0,0,0.45)] space-y-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <button
            ...
            className={`inline-flex items-center gap-2 rounded-2xl px-6 py-3 text-sm font-semibold shadow-[0_15px_30px_rgba(0,0,0,0.35)] ${
              isCreateOpen ? 'bg-[#1c2b30] text-[#9fc3c1]' : 'bg-gradient-to-r from-[#0f5d63] via-[#16a7a1] to-[#d4b673] text-[#0a1217]'
            }`}
          >
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center">
          <div className="relative flex-1">
            <input
              ...
              className="w-full rounded-2xl border border-[#1c3f4c] bg-[#08131b] pl-12 pr-4 py-3 text-sm text-white placeholder:text_WHITE/40 focus:border-[#0f5d63] focus:outline-none"
            />
            <svg
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#050f15] via-[#071922] to-[#041017] text-slate-100">
        <div className="container mx-auto px-4 py-8">
          <div className="mb-6">
            <button onClick={handleBack} className="inline-flex items-center gap-2 text-[#8fbab9] hover:text-white transition">
          ...
          <div className="max-w-6xl mx-auto">{stack}</div>
        </div>
      </div>
    );
  }

  return <section className={className}>{stack}</section>;
};
