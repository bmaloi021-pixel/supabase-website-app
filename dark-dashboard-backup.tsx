...
export default function Dashboard() {
                      ...
                      <div>
                        ...
                        <div className="mt-1 text-xs text-gray-600">
                          {m.type === 'gcash' ? (
                            ...
                            <span>
                              {m.account_name}
                              {m.account_number_last4 ? ` ÔÇó ****${m.account_number_last4}` : ''}
                            </span>
                          )}
                        </div>
                      </div>
            ...
            <div className="flex-1">
              ...
              <div className="relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <span className="text-gray-500 sm:text-sm">Ôé▒</span>
                </div>
                <input
                  type="number"
                  name="amount"
  ...
  const renderUsers = () => (
    <div className="bg-white rounded-lg shadow overflow-hidden">
      ...
      {usersListLoading ? (
        <div className="px-6 py-8 text-center text-sm text-gray-500">Loading usersÔÇª</div>
      ) : (
        (() => {
            ...
            >
              ...
              {profile?.role === 'admin' ? (
                <div className="mt-4 grid grid-cols-2 gap-3">
                  ...
                  >
                    {packageAdminLoading ? 'WorkingÔÇª' : 'Delete'}
                  </button>
                </div>
              ) : (
                <div className="mt-4">
            ...
            <div className="w-full max-w-lg rounded-lg bg-white shadow-xl">
              ...
              <div className="px-6 py-4 border-t border-gray-200 flex justify-end gap-3">
                ...
                <button
                  ...
                  disabled={packageAdminLoading}
                >
                  {packageAdminLoading ? 'SavingÔÇª' : 'Create'}
                </button>
              </div>
            </div>
          </div>
